  ...
  <footer id="footer" class="footer">
    ...
    <div class="container">
      <div class="row gy-4">
        <div class="col-lg-5 col-md-12 footer-info">
          ...
          <p>This is a vulnerable website created especially for ethical hacking beginners. Login form above has a MYSQL injection vurnability. We challenge you to do MYSQL injection and login to the site without credentials. </p>
    ...
    <div class="container mt-4">
      ...
      <div class="credits">
        ...
        Designed by <a href="https://bootstrapmade.com/">Spark Branch UOM</a>
      </div>
    </div>
